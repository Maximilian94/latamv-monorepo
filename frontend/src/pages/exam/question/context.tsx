...
export const QuestionProvider = ({ children }: { children: ReactNode }) => {
    ...
    return <QuestionContext.Provider value={{ currentQuestion, setCurrentQuestion, totalQuestions, setTotalQuestions, questions, onOptionSelect }}>{children}</QuestionContext.Provider>;
}